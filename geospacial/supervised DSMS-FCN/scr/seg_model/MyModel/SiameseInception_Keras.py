...
class SiameseInception(object):
    ...
    def get_model(self, input_size):
        ...
        diff_fea_1 = Abs_layer(Subtract()([feature_1_X, feature_1_Y]))  # (B, H, W, 16)
        diff_fea_2 = Abs_layer(Subtract()([feature_2_X, feature_2_Y]))  # (B, H/2, W/2, 32)
        diff_fea_3 = Abs_layer(Subtract()([feature_3_X, feature_3_Y]))  # (B, H/4, W/4, 64)
        diff_fea_4 = Abs_layer(Subtract()([feature_4_X, feature_4_Y]))  # (B, H/8, W/8. 128)
